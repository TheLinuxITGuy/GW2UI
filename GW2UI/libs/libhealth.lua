...
libhealth:SetScript("OnEvent", function()
  if event == "PLAYER_ENTERING_WORLD" then
    ...
    GW2UI_cache["libhealth"] = GW2UI_cache["libhealth"] or {}
    mobdb = GW2UI_cache["libhealth"]
...
GW2UI.libhealth = libhealth
GW2UI.libhealth.GetUnitHealth = GetUnitHealth
GW2UI.libhealth.GetUnitHealthByName = GetUnitHealthByName
