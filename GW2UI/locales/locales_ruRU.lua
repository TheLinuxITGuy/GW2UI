...
GW2UI_locale["ruRU"]["bagtypes"] = {
  ["Колчан"] = "QUIVER",
  ["Сумка душ"] = "SOULBAG",
  ["Сумка"] = "DEFAULT",
}

GW2UI_locale["ruRU"]["itemtypes"] = {
  ["INVTYPE_WAND"] = "Жезл",
...
GW2UI_locale["ruRU"]["hunterpaging"] = {
  ["MELEE"] = "Подрезать крылья",
  ["RANGED"] = "Чародейский выстрел",
}

GW2UI_locale["ruRU"]["customcast"] = {
  ["AIMEDSHOT"] = "Прицельный выстрел",
  ["MULTISHOT"] = "Залп",
}

GW2UI_locale["ruRU"]["critters"] = {
  'Аспид',
  'Жук',
  'Чердачный нетопырь',
  'Желчная жаба',
...
GW2UI_locale["ruRU"]["resurrections"] = {
  ["Воскрешение"] = true,
  ["Возрождение"] = true,
  ["Искупление"] = true,
  ["Дух предков"] = true,
...
GW2UI_locale["ruRU"]["debuffs"]['Конус холода']={[0]=8.0,} -- Cone of Cold

GW2UI_locale["ruRU"]["totems"] = {
