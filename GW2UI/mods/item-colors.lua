...
module.enable = function(self)
  do -- paperdoll
    local refresh_paperdoll = function()
      for i, slot in pairs(paperdoll_slots) do
        ...
        if button then
          local border = button.GW2UI_border
        ...
        if frame then
          ...
          for i = 1, MAX_CONTAINER_ITEMS do
            ...
            if not defcolor["bag"] then
              defcolor["bag"] = { button.GW2UI_border:GetBackdropBorderColor() }
            end

            button.GW2UI_border:SetBackdropBorderColor(defcolor["bag"][1], defcolor["bag"][2], defcolor["bag"][3], 1)
            ...
            if button and button:IsShown() and link then
              ...
              if quality then
                local r, g, b = GetItemQualityColor(quality)
                button.GW2UI_border:SetBackdropBorderColor(r,g,b)
              end
            end
          end
        end
      ...
      for i = 1, 28 do
        ...
        if button then
          if not defcolor["bank"] then
            defcolor["bank"] = { button.GW2UI_border:GetBackdropBorderColor() }
          end
  ...
  do -- weapon buff
    ...
    function BuffFrame_Enchant_OnUpdate(elapsed)
      ...
      TempEnchant1.GW2UI_border:SetBackdropBorderColor(r,g,b,1)
      ...
      TempEnchant2.GW2UI_border:SetBackdropBorderColor(r,g,b,1)
