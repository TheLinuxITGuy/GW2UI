...
module.enable = function(self)
  GW2UI_config = GW2UI_config or {}
  GW2UI_config["MoveUnitframesExtended"] = GW2UI_config["MoveUnitframesExtended"] or {}
  local movedb = GW2UI_config["MoveUnitframesExtended"]
