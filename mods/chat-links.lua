...
local rgbhex = GW2UI.rgbhex
local strsplit = GW2UI.strsplit
...
local CopyLinkDialog = CreateFrame("Frame", "GW2UIURLCopy", UIParent)
CopyLinkDialog:Hide()
...
CopyLinkDialog.text = CreateFrame("EditBox", "GW2UIURLCopyEditBox", CopyLinkDialog)
...
CopyLinkDialog.close = CreateFrame("Button", "GW2UIURLCopyClose", CopyLinkDialog, "UIPanelButtonTemplate")
