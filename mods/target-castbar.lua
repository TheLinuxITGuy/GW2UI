...
local UnitCastingInfo = GW2UI.UnitCastingInfo
local UnitChannelInfo = GW2UI.UnitChannelInfo
...
module.enable = function(self)
  ...
  TargetFrame:SetScript("OnUpdate", function(arg)
    ...
    if GW2UI.superwow_active and this.unit and not UnitIsUnit(this.unit, 'player') then
