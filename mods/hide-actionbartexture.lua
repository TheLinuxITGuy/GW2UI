...
local module = GW2UI:register({
  ...
  description = "Hides the texture around the actionbars.",
...
module.enable = function(self)
  ...
  MainMenuExpBar:SetWidth(screenWidth+100)
  MainMenuExpBar:SetHeight(MainMenuExpBar:GetHeight()-6)
  ...
  -- move MultiBarRight up
  MultiBarRight:ClearAllPoints()
  MultiBarRight:SetPoint("TOPRIGHT", Minimap, -1, 510)

  -- Function to hide original actionbar buttons
  local function HideOriginalActionBarButtons()
    for i = 1, 12 do
