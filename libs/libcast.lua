...
local libcast = CreateFrame("Frame", "GW2UIEnemyCast")
local player = UnitName("player")

GW2UI.UnitChannelInfo = _G.UnitChannelInfo or function(unit)
...
GW2UI.UnitCastingInfo = _G.UnitCastingInfo or function(unit)
  -- convert to name if unitstring was given
  unit = valid_units[unit] and UnitName(unit) or unit
...
local function CastCustom(spell)
  ...
  if not GW2UI.UnitCastingInfo(UnitName("player")) then
