...
local libtipscan = GW2UI.libtipscan
local libspell = GW2UI.libspell
local hooksecurefunc = GW2UI.hooksecurefunc
local cmatch = GW2UI.cmatch
...
resetcache:SetScript("OnEvent", function()
  if event == "PLAYER_ENTERING_WORLD" then
    ...
    GW2UI_cache = GW2UI_cache or {}
    GW2UI_cache["prediction"] = GW2UI_cache["prediction"] or {}
    GW2UI_cache["prediction"][realm] = GW2UI_cache["prediction"][realm] or {}
    GW2UI_cache["prediction"][realm][player] = GW2UI_cache["prediction"][realm][player] or {}
    GW2UI_cache["prediction"][realm][player]["heals"] = GW2UI_cache["prediction"][realm][player]["heals"] or {}
    cache = GW2UI_cache["prediction"][realm][player]["heals"]
    return
  end
...
libpredict.sender = CreateFrame("Frame", "GW2UIPredictionSender", UIParent)
